...
module.exports = {
    ...
    run: async (client, interaction, args) => {
      ...
      .setAuthor({ name: `HackerManager Staff Application`, iconURL: `${client.user.displayAvatarURL()}` })
      .setColor('#2f3136')
      .setFooter(`Made with 💖 by discord.azury.live`) 
      .setDescription(`**Apply for a <@&962255185026105364> where you can help moderate ActiveDev! And even get to a high respectable rank!**\n\n***Click the \`button\` below to open a application ticket!***`)
      .setImage(``)
