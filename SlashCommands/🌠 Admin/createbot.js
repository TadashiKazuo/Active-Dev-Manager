...
module.exports = {
    ...
    run: async (client, interaction, args) => {
      if(!interaction.member.roles.cache.has("964136576798048326")) return interaction.followUp(`❌ **Only BOT CREATORS can use this command!**`)
      return interaction.followUp(`**This command is coming soon! Please create the bot at https://admin.activedev.tk**`)
